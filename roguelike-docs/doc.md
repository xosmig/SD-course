...
* Выжившие сущности регенерируют
* Монстры и игрок совершают ход
...
Компоненты:
* Configuration (commons) - загружает и хранит все конфигурационные данные игры.
* GameModel (game-model) - хранит описание мира и его объектов
* Factories (game-model) - генерируют различные игровые объекты по запросу
* GameLogic (game-logic) - логика жизни мира и взаимодействия объектов в нем
* UICommon (ui-common) - базовое описание взаимодействия игрока с игровой логикой
* ConsoleUI (console-ui) - имплементация UICommon для терминала
* UserInputHandler (console-ui) - хендлер для удобного получения ввода-вывода от пользователя

![components](https://github.com/ArgentumWalker/SD-course/raw/hw07/roguelike-docs/Components.png)
