...
* Интеллект - определяет силу магичесуих ударов.
...
* Ожоги - наносит пермоментный урон.
...
* Безногим - уменьшает количество конечностей, взамен увеличивает силу предмета в зависимости от количества потеряных конечностей. Крайне редкий модификатор. 
